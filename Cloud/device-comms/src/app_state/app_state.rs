...
#[derive(Clone)]
pub struct AppState {
    /// Cosmos DB client for telemetry data storage operations
    /// 
    /// This client is used by telemetry ingestion handlers to store
    /// incoming device data in the Cosmos DB database.
