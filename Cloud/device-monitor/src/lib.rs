// Device Monitoring Service Library
// 
// This library provides a REST API for retrieving and monitoring telemetry data
// from IoT devices. It uses Rocket web framework with structured logging,
// CORS support, and Cosmos DB storage.
...
/// for the device monitoring service.
...
impl Application {
    ...
    /// 5. Mounts the telemetry monitoring routes
    /// 
    /// # Arguments
    ...
    pub async fn build(app_state: AppState) -> Result<Self, Box<dyn std::error::Error>> {
        ...
        let server = rocket::build()
            ...
            // Mount the telemetry monitoring endpoint
